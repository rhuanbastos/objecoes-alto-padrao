...
module.exports = [
  ...
  {
    cat: "Perfil do Investidor",
    quote: "Sou do Rio, acho complicado investir tão longe pra acompanhar de perto. Gosto de visitar e ficar de olho no que é meu.",
    behind: "Objeção em duas camadas: primeiro é a distância geográfica, mas mesmo depois de saber que tem gestora cuidando de tudo (Housi, Seazone), o cliente ainda pontua que prefere acompanhar pessoalmente. Não é desconfiança da gestão, é perfil de investidor mais hands-on.",
    technique: "Validar o perfil sem contradizer + usar o potencial de retorno da região pra justificar abrir mão da presença física",
    script: "Isso mostra que você cuida bem do seu patrimônio, faz todo sentido querer acompanhar de perto. Aqui na Tríade a valorização histórica roda na faixa de 20% a 30% ao ano, e a gestão fica com parceiros como Housi e Seazone, que cuidam de locação, manutenção e mobília com relatório direto no app.\n\nBora eu agendar uma call com nosso closer? Ele te mostra os números reais de um imóvel específico, aí você decide com dado na mão se compensa trocar a presença física por esse potencial de retorno.",
    tone: "Nunca contradiga o perfil hands-on do cliente, valide primeiro. O potencial de retorno é o argumento aqui, não a praticidade da gestão remota (essa já foi citada e sozinha não convenceu).",
    keywords: "rio de janeiro rj distância longe acompanhar de perto presente presença física gestora administração locação housi seazone mora longe gosto de acompanhar"
  },
  {
    cat: "Timing e Mercado",
